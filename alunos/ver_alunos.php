      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col text-end">
                <button class="btn btn-primary" onclick="location.href='editar_alunos.php?id=<?php echo $id?>';
                ">Editar</button>
            </div>
        </div>
    </div>
...
<?php
        ...
        <p> Clique <a href='listar_alunos.php'>aqui</a> para acessar o formulário de cadastro.</p>
        ";
    } //tratamento de dados
?>