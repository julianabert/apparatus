...
<html lang="en">
  ...
  <body>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nome" name="nome" aria-describedby="emailHelp" required value="<?php echo $nome?>">
      </div>
      ...
      <div class="mb-3">
          ...
          <input type="text" class="form-control" id="endereco" name="endereco" required value="<?php echo $endereco?>">
      </div>
